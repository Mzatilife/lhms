...
<div id="container" class="row justify-content-md-center">
   ...
   <table id="comp" class="table table-hover table-inverse  table-bordered table-center table-striped mt-2 border-top" style="font-size:24px; align-content:center;">  
		...
		<tbody>
				<?php
					$select = "SELECT * FROM messages WHERE Is_reply = 0 AND deleted=0";
				...
				?>
					...
					<td><button type="button" class="btn btn-info reply" id='<?php echo $row['Student_id'].' '.$row['Message_id'] ?>' data-toggle="modal" data-target="#modelId" >Reply <i class="fa fa-reply" aria-hidden="true"></i></button>
					<button type="button" class="btn btn-danger delete_m" id='<?php echo $row['Message_id'] ?>' data-toggle="modal" data-target="#delete_m" >delete <i class="fa fa-trash" aria-hidden="true"></i></button>
</td>
...
<div class="modal lg fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<p  style="font-size: 30px;font-weight:bold; text-align: center;">Reply complaint</p>
				...
				<div class="row">
					<div style="font-size: 25px;" class="col-md-6">
							<div class="form-group">
            			 	...
            			 	<input style="font-size: 25px;font-style: italic;" type="text" name="studID" id="studID" class="form-control form-control-lg" readonly placeholder="ID here..." aria-describedby="helpId">
           						</div>
					</div>
					<div class="col-md-6">
		   ...
		   <div class="form-group">
             <label style="font-size: 25px;" for="">Student Name</label>
             <input style="font-size: 25px;font-style: italic;" type="text" name="studN" id="studN" class="form-control form-control-lg" readonly placeholder="Name here..." aria-describedby="helpId">
             ...
             <input style="font-size: 25px;font-style: italic;"class="form-control form-control-lg" name="msg" id="msg" rows="5" readonly placeholder='Type description here...'>
           </div> 

           <div class="form-group">
             <label style="font-size: 25px;" for="">Description</label>
             <textarea style="font-size: 25px;font-style: italic;" class="form-control form-control-lg" name="repdes" id="" rows="5" placeholder='Type description here...' required></textarea>
           </div> 

           <div class="text-center">
           <button type="submit" class="btn btn-info btn-lg" name='reply'>Reply</button>
           </div>
				</form>
			</div>
...
<div class="modal fade" id="delete_m" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <p style="font-size: 30px;font-weight:500;">Do you want to delete message?</p>
...
</html><script type="text/javascript" src="web_home/js/jquery-3.3.1.min.js"></script>

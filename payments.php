                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="manageP" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="payments.php">Clear payments</a>
									<a class="nav-link" href="approved.php">Cleared payments</a>
...
<div id="container" class="row justify-content-md-center">
   ...
   <table id="example" class="table table-hover table-inverse  table-bordered table-center table-striped mt-2 border-top" style="font-size:24px; align-content:center;">  
		...
		<tbody>
				<?php
					$select = "SELECT * FROM payments WHERE Is_approved=0 ";
				...
				?>
					...
					<td><button type="button" class="btn btn-success approve" id='<?php echo $row['Student_Id'].'-'.$row['Payment_id']?>' data-toggle="modal" data-target="#payment" >clear<i class="fas fa-thumbs-up"aria-hidden="true"></i></button></td>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content" style="font-size:26px">
				<div class="modal-header">
						<h5 style="font-size: 25px;font-weight: bold;"class="modal-title">clear payment </h5>
			...
			<div class="modal-body" >
				<div class="container-fluid ">
					<p style="font-size: 30px; text-align: center;">Do you want to clear payment? </p> 
				</div>
				</div>
			</div>
			</div>

...
<div id="container" class="row justify-content-md-center">
	 ...
	 <div class="card mb-4" style="width:95%">
				...
				<div class="card-body">
   <table id="example" class="table table-hover table-inverse  table-bordered table-center table-striped mt-2 border-top" style="font-size:22px; align-content:center;">  
		...
		<tbody>
				<?php
					$select = "SELECT * FROM student_application WHERE App_status = 1 ";
...
<div class="modal fade" id="vacateModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
				...
				<p  style="font-size: 30px;font-weight:bold; text-align: center;">vacate</p>
			...
			<input type="text" name="RoomNo" id="RoomNo" class="form-control"  aria-describedby="helpId">
						...
						<p style="font-size: 30px;font-weight:500;">Do you want to vacate?</p>
			            </div>
				</div>

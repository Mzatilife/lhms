...
{
	$query = "SELECT * FROM messages WHERE Is_mailed = 0 AND Fault_type='furniture'";
...
<html>
	<head>
		<title>Send Furniture Details</title>
...
<div id="container" class="row justify-content-md-center">
			...
			<br />
			<form method="post">
				<input type="submit" name="action" class="btn btn-danger" value="Send PDF" style="margin-left:1;  margin-bottom: 2em;font-size: large; margin-top:0.01em" />
			</form>
		</div>
